...
export const api = {
  ...
  createLiveClass: (payload) => request("/api/live-classes", { method: "POST", body: payload }),
  updateLiveClass: (liveClassId, payload) => request(`/api/live-classes/${liveClassId}`, { method: "PUT", body: payload }),
  deleteLiveClass: (liveClassId) => request(`/api/live-classes/${liveClassId}`, { method: "DELETE" }),
