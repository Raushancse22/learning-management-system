  ...
  return get(
    `
      SELECT
        ...
        po.status,
        po.gateway,
        po.gateway_order_id AS gatewayOrderId,
        po.gateway_payment_id AS gatewayPaymentId,
        po.gateway_signature AS gatewaySignature,
        po.gateway_receipt AS gatewayReceipt,
  ...
  return get(
    `
      SELECT
        ...
        gateway_receipt AS gatewayReceipt,
